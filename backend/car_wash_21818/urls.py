"""car_wash_21818 URL Configuration
...
admin.site.site_header = "car wash"
admin.site.site_title = "car wash Admin Portal"
admin.site.index_title = "car wash Admin"

# swagger
api_info = openapi.Info(
    title="car wash API",
    default_version="v1",
    description="API documentation for car wash App",
)
